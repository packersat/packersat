...
export default async function handler(req, res) {
  // Handle CORS preflight — confirm.html calls this by absolute Vercel URL
  // (not a relative /api/ path), so this is a genuine cross-origin request
  // whenever the page itself is served from packersat.org.
